      ...
      <>
         ...
         <div>
            ...
            <div style={{marginTop:"10px"}}>
                ...
                <button style={{margin:"10px"}} disabled={page===1} onClick={()=>setPage(page-1)} >PRE</button>
                <button  style={{margin:"10px"}} disabled={page===data?.total_pages} onClick={()=> setPage(page+1)} >NEXT</button>
